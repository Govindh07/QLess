...
import 'package:q_less/QLess/Screens/help_support.dart';
import 'package:q_less/QLess/Screens/log_out.dart';
import 'package:q_less/QLess/Screens/payment_history.dart';
import 'package:q_less/QLess/Screens/payment_page.dart';
import 'package:q_less/QLess/Screens/payment_ui.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          GestureDetector(
              ...
              child: buildSettingItem(Icons.history, "Payment history")),
          GestureDetector(
              onTap: (){
